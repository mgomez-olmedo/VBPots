...
/**
  ...
  */
object VETableTreeMIMOptSelectBenchmark extends App {
   ...
   val combAlternatives =
      bnetMapIndices.potentials(0).store.combinationFunctions
   val margAlternatives =
      bnetMapIndices.potentials(0).store.marginalizationFunctions
